...
import heroImageDesktop from "@/assets/why.png";
import heroImageMobile from "@/assets/why2.png";
	...
	return (
		<section className="relative min-h-screen flex items-center overflow-hidden grain-overlay">
			...
			<div className="absolute inset-0">
				...
				{/* Overlay marron → orange pour teinte chaleureuse */}
			...
			{/* Content positioned on the left on mobile, right on desktop */}
			<div className="container mx-auto px-2 md:px-8 relative z-10 py-20">
					...
					<ScrollReveal delay={100}>
						<div className="mb-8 md:mb-12 flex items-center gap-4">
							...
							<div className="flex items-center gap-3 mt-2">
								<div className="h-[2px] w-12 bg-gray-400" />
							</div>
						</div>
					</ScrollReveal>
